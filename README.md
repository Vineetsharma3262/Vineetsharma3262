...
![Profile Views](https://visitcount.itsvg.in/api?id=Vineetsharma3262&icon=0&color=0)

![GitHub Stats](https://github-readme-stats.vercel.app/api?username=Vineetsharma3262&show_icons=true&theme=radical&cache_seconds=1800)

![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=Vineetsharma3262&layout=compact&theme=radical&cache_seconds=1800)
...
- 🤝 Experience leading and mentoring frontend teams
...
### 🤖 Q-Brain – Enterprise AI Web App
**Tech:** React, TypeScript, Redux Toolkit, MUI, SSE/WebSockets  
- Built conversational AI interface for natural-language data queries  
- Real-time streaming UI with visualization dashboards  
- Export to PDF, insight sharing, session management  
- Led 2-member frontend team

---

### ☁ Scaleflow – Cloud Storage Scaling
**Tech:** React, Redux, Node, AWS  
- Improved Lighthouse score **70 → 95**  
- Real-time monitoring dashboards  
- Reduced DOM re-renders by **30%**  
- Zero-downtime CI/CD pipeline

---

### 📊 LogEasy – AI Log Management
**Tech:** Next.js, Redux, Tailwind  
- NLP-powered log analysis  
- SSR optimizations (30% faster load)  
